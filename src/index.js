...
function printGrafo(grafo) {
  ...
  if (lastNode) {
    while (lastNode) {
      return_string += lastNode.data.print();
...
app.post("/api/insert", (req, res) => {
  ...
  if (Grafo) {            //////////////////////////////////  Verifica se vertice já existe no array
  ...
  if(Ve.value!="" && Ve2.value!=""){    ////////////////  se nenhum dos vertices é vazio cria uma aresta/arco
